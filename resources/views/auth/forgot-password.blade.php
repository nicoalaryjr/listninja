            ...
            <form class="mt-8 space-y-6" action="{{ route('password.email') }}" method="POST">
                ...
                <div>
                    ...
                    <input id="email" name="email" type="email" autocomplete="email" required
                           class="appearance-none rounded relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-accent focus:border-accent focus:z-10 sm:text-sm @error('email') border-red-500 @enderror"
